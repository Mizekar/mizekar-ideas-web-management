                                        ...
                                        <TabContent activeTab={this.state.activeTab}>
                                            ...
                                            <TabPane tabId="3">
                                                <FieldArray
                                                    ...
                                                    render={(arrayHelpers) => (
                                                        <div>
                                                            {values.medias.map((data, index) => (
                                                                <Card key={index}>
                                                                    <CardBody>
                                                                        <FormGroup row>
                                                                            <Col xs="12" md="10" className=" mb-0">
                                                                                ...
                                                                                <Input
                                                                                    ...
                                                                                    onChange={(event) => {
                                                                                        setFieldValue(`medias[${index}]`, event.currentTarget.files[0])
                                                                                    }}
                                                                                />
                                                                            </Col>
                                                                            <Col xs="12" md="2"
                                                                                 className="pl-0 upload-img-box">
                                                                                <div>
                                                                                    <img src={this.state.image}
                                                                                         className="upload-img" alt=""/>
                                                                                </div>
                                                                            </Col>
